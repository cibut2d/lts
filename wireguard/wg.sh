...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/cibut2d/reg/main/ip | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# ==================================================
# Link Hosting Kalian
bantur="raw.githubusercontent.com/cibut2d/lts/main/wireguard"
...
echo -e "${Info} Wireguard Script By JULAK BANTUR"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/cibut2d/lts/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/cibut2d/lts/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/cibut2d/lts/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
