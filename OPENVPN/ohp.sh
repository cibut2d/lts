#!/bin/bash
#Open HTTP Puncher By JULAK BANTUR
...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/cibut2d/lts/main/OPENVPN/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By Julak
