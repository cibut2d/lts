...
curl "https://raw.githubusercontent.com/cibut2d/lts/main/sshws/insshws.sh" | bash



wget -O /usr/local/bin/edu-proxy https://raw.githubusercontent.com/cibut2d/lts/main/sshws/openssh.py && chmod +x /usr/local/bin/edu-proxy
